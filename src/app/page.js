...
export default function Home() {
  ...
  return (
    <>
            ...
            <div className="col-12">
              <div className="hero-content text-center text-white position-absolute top-50 start-50 translate-middle w-100">
                ...
                <p className="lead mb-5">
                  Simplifying relocation for migrants and students
                </p>
              ...
              <div
                ...
                style={{
                  height: "600px",
                  background:
                    "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=80&w=2070&auto=format&fit=crop')",
              ...
              <div className="row mt-4">
                <div className="col-md-6 mb-4">
                  <div className="card h-100 border-0 shadow-sm">
                    <div className="card-body">
                      <div
                        className="feature-icon bg-primary bg-gradient text-white rounded-circle mb-3 d-inline-flex align-items-center justify-content-center"
                      ...
                      <p className="mb-0">
                        ...
                        accommodation, explore job opportunities.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6 mb-4">
                  <div className="card h-100 border-0 shadow-sm">
                    <div className="card-body">
                      <div
                        className="feature-icon bg-success bg-gradient text-white rounded-circle mb-3 d-inline-flex align-items-center justify-content-center"
                        style={{ width: "50px", height: "50px" }}
                      >
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-5">
            ...
            >
              Providing a centralized hub of essential information and resources
              to address the common challenges faced by newcomers.
            </p>
          </div>
              ...
              <div key={index} className="col-md-4">
                <div className="card h-100 border-0 shadow-sm overflow-hidden">
                  ...
                  <div className="card-footer bg-transparent border-0">
                    <Link
                      href={session ? serviceLinks[index] : "/signup"}
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 order-lg-2 mb-4 mb-lg-0">
              ...
              <p className="lead">
                Our user-friendly platform is designed to ease the transition
                for migrants and students moving to unfamiliar towns.
              </p>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              ...
              <p className="mb-4">
                ...
                resources they need to navigate their new environments.
              </p>
              <Link href="/about">
      ...
      {/* Testimonial and last call-to-action */}
      <section className="py-5">
        <div className="container text-center">
          <div className="mx-auto" style={{ maxWidth: "800px" }}>
            ...
            <blockquote className="blockquote mb-5">
              <p className="fs-4">
                Sehar Sehpathi has been a game-changer for me. It provided me
                with all the necessary information to smoothly transition to a
                new town.
              </p>
